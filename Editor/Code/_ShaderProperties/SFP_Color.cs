...
namespace ShaderForge {
	...
	public class SFP_Color : SF_ShaderProperty {
		...
		public override string GetInitializationLine() {
			return GetTagString() + GetVariable() + " (\"" + nameDisplay + "\", Color) = (" + GetValue().r.ToString(CultureInfo.InvariantCulture) + "," + GetValue().g.ToString(CultureInfo.InvariantCulture) + "," + GetValue().b.ToString(CultureInfo.InvariantCulture) + "," + GetValue().a.ToString(CultureInfo.InvariantCulture) + ")";
		}
